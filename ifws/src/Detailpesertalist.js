...
const Detailpesertalist = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `${API_URL}/panitia/datapesertazoom/${dataKegiatan.id_kegiatan}`,
        {
          method: "GET",
          headers: {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/panitia/pesertatugasakhirzoom`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${API_TOKEN}`,
        },
...
const DetailpesertalistComponent = () => {
  return (
...
export default DetailpesertalistComponent;
