...
const Pesertatugasakhir = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`${API_URL}/panitia/datapeserta`, {
        method: "GET",
        headers: {
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Tooltip title="Delete">
                        <IconButton
                          color="error"
                          onClick={() => handleDelete(panitia.id_peserta)}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </Tooltip>
...
const DetailpesertatugaskahirComponent = () => {
  return (
...
export default DetailpesertatugaskahirComponent;
